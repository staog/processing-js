...
var sunflower = new Sunflower(138, 390, 100);
var secondTulip = new Tulip(238, 390, 75); 
var secondSunflower = new Sunflower(338, 390, 125);
...
var drawScene = function() {
    ...
    sunflower.draw();
    secondTulip.draw();
    secondSunflower.draw();
};

mouseClicked = function() {
    tulip.growBy(10);
    sunflower.growBy(20);
    secondTulip.growBy(30);
    secondSunflower.growBy(5);
    drawScene();
};
